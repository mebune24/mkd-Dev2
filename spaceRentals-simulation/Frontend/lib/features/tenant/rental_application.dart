...
class _RentalApplicationState extends ConsumerState<RentalApplication> {
  ...
  Widget build(BuildContext context) {
    ...
    final hasChanges =
        _coverLetterCtrl.text.isNotEmpty || _uploadedDocs.values.any((v) => v);

    return FormSafeModal(
      hasUnsavedChanges: hasChanges,
      discardTitle: 'Abandon Application?',
      discardMessage:
          'You have started filling out this application. Are you sure you want to leave? Your progress will be lost.',
      child: Scaffold(
        ...
        body: SingleChildScrollView(
          ...
          child: Column(
            ...
            children: [
              ...
              _buildSummaryRow(
                'Monthly Rent',
                CurrencyFormatter.formatCFA(p.monthlyRentUnits.toDouble()),
                note:
                    'Paid directly to your landlord — not collected by Space Rentals',
              ),
              const SizedBox(height: 8),
              _buildSummaryRow(
                'Required Deposit',
                CurrencyFormatter.formatCFA(p.depositUnits.toDouble()),
                  ...
                  children: [
                    ...
                    Row(
                      ...
                      children: [
                        ...
                        Text(
                          SpaceFees.tenantApplicationFee.formatted(),
              ...
              TextField(
                ...
                decoration: InputDecoration(
                  hintText:
                      'Introduce yourself and explain why you would be a great tenant...',
                  filled: true,
                          ...
                          : ElevatedButton(
                              onPressed: entry.value
                                  ...
                                  : () async {
                                      ...
                                      try {
                                        final path = await StorageService
                                            .instance
                                            .uploadFile(file, 'kyc-documents');
                                        setState(() {
