                        ...
                        Padding(
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              Text(
                                '${p.property.location}  ·  ${p.property.category}',
                                style: const TextStyle(
                                  color: Colors.grey,
                                  fontSize: 12,
                                ),
                              ...
                              Text(
                                'Landlord ID: ${p.property.landlordId}',
                                style: const TextStyle(
                                  color: Colors.grey,
                                  fontSize: 11,
                                ),
                                    ...
                                    IconButton(
                                      ...
                                      onPressed: () async {
                                        final response = await ref
                                            .read(apiClientProvider)
                                            .patch(
                                              ApiEndpoints.unpublishProperty(
                                                p.property.id,
                                              ),
                                            );
                                        if (!context.mounted) return;
  ...
  Widget _buildStatusBadge(String status) {
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        border: Border.all(
          color: (colors[status] ?? Colors.grey).withValues(alpha: 0.4),
        ),
      ),
      child: Text(
        status.toUpperCase(),
